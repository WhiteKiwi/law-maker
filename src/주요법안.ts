...
async function get주요법안표결(의안번호: number): Promise<{
  ...
  const res: any = await axios.post(
    ...
    `billNo=${의안번호}&_csrf=c4585f1e-fb30-4419-9491-e70fc56e3b23`,
    {
      headers: {
        Accept: "*/*",
        ...
        Cookie:
          "PHAROSVISITOR=000031ae018e9e9f26e135ec0ac965a5; JSESSIONID=f11Rhbv3brdZ5mDM6Bwo19tDXeOY6NTNZfyH5KF7DDcntSTfzpJZK4mfa8pFZ3jH.amV1c19kb21haW4vbmFob21lMQ==",
        DNT: "1",
